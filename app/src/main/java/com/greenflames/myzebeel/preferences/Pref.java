package com.greenflames.myzebeel.preferences;
...
public class Pref {
    ...
    public Pref(Context appContext) {
...
//     * @param the pref key
    ...
    public void putList(String position_value, ArrayList<Integer> position_stored) {
        checkForNullKey(position_value);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Object obj : position_stored){
            objStrings.add(gson.toJson(obj));
        }
        putListString(position_value, objStrings);
    }

    public void putString(String field, int k) {
    }
}
