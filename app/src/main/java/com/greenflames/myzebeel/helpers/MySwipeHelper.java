...
public abstract class MySwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public class MyButton {
        ...
        public void  onDraw(Canvas c,RectF rectF,int pos){
            ...
            if (imageResId==0){
                ...
                Bitmap bitmap=drawableTopBitmap(d);
    ...
    private Bitmap drawableTopBitmap(Drawable d) {
        ...
        if (actionState==ItemTouchHelper.ACTION_STATE_SWIPE){
            if (dX<0){
                ...
                if (!buttonBuffer.containsKey(pos)){
                    instantiateMyButton(viewHolder,buffer, pos);
    ...
    public abstract void instantiateMyButton(RecyclerView.ViewHolder viewHolder, List<MyButton> buffer, int pos);
